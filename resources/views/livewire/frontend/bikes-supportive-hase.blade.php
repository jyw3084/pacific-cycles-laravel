  ...
  <nav aria-label="breadcrumb" class="breadcrumb-1 b-about p-3">
    <div class="container" style="text-align: center">
      <div class="bikes-desktop-view">
        ...
        <a class="text-light pc-link-active ml-5" href="/bikes/supportive">SUPPORTIVE</a>
      </div>
      <div class="dropdown-mobile-view">
        <a class="text-light pc-link-active ml-5" href="#" id="mobileBikeTitle">SUPPORTIVE <i class="fa fa-angle-down"></i></a>
        <div id="bikedropdown">
          <a class="text-light pc-link mr-5" href="/bikes/folding">FOLDING BIKES</a>
          <a class="text-light pc-link ml-5 mr-5" href="/bikes/ebike">E-BIKES</a>
        </div>
  ...
  <nav aria-label="breadcrumb" class="breadcrumb-2">
    <div class="container">
      <ol class="breadcrumb breadcrumb-2">
        ...
        <li class="breadcrumb-item breadcrumb-2-items"><a href="/bikes/supportive">{{ $category }}</a></li>
