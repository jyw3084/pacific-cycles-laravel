...
<div>
  <nav aria-label="breadcrumb" class="breadcrumb-1 b-about p-3">
    <div class="container" style="text-align: center">
      <div class="bikes-desktop-view">
        <a class="text-light pc-link-active mr-5" href="/bikes/folding">FOLDING BIKES</a>
        <a class="text-light pc-link ml-5 mr-5" href="/bikes/ebike">E-BIKES</a>
        <a class="text-light pc-link ml-5" href="/bikes/supportive">SUPPORTIVE</a>
      </div>
      <div class="dropdown-mobile-view">
        <a class="text-light pc-link-active ml-5" href="#" id="mobileBikeTitle">FOLDING BIKES <i class="fa fa-angle-down"></i></a>
        <div id="bikedropdown">
          <a class="text-light pc-link mr-5" href="/bikes/ebike">E-BIKES</a>
  ...
  <nav aria-label="breadcrumb" class="breadcrumb-2">
    <div class="container">
      <ol class="breadcrumb breadcrumb-2">
        ...
        <li class="breadcrumb-item breadcrumb-2-items"><a href="/bikes/folding">{{ $category }}</a></li>
  ...
  <div class="container">
    <div class="mt-5 mb-5">
      <div class="mb-5">
        <span class="headings">FOLDING BIKES<div class="v-line"></div>REACH</span>
      </div>
      <div>
        <span class="headings">THE VERSATILE FOLDING BIKE</span>
        <p class="mt-4">BIRDY is a lifestyle. An attitude. An ideal adventure companion for those who'd rather not
          walk. Small enough to fit almost anywhere. When opened out, better than many big bikes. It is still the
          folder to beat in terms of looks, comfort and performance.
        </p>
      </div>
    </div>
  </div>
