  ...
  <nav aria-label="breadcrumb" class="breadcrumb-1 b-about p-3">
    <div class="container" style="text-align: center">
      <div class="bikes-desktop-view">
        ...
        <a class="text-light pc-link-active ml-5 mr-5" href="/bikes/ebike">{{ strtoupper($category[1]->name) }}</a>
        <a class="text-light pc-link ml-5" href="/bikes/supportive">{{ strtoupper($category[2]->name) }}</a>
      </div>
      <div class="dropdown-mobile-view">
        <a class="text-light pc-link-active ml-5" href="#" id="mobileBikeTitle">{{ strtoupper($category[1]->name) }} <i class="fa fa-angle-down"></i></a>
        <div id="bikedropdown">
          <a class="text-light pc-link mr-5" href="/bikes/folding">{{ strtoupper($category[0]->name) }}</a>
