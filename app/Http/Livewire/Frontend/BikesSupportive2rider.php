...
class BikesSupportive2rider extends Component
{
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', '2RIDER'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', '2RIDER'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-supportive-2rider', [
