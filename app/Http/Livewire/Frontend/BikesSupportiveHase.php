...
class BikesSupportiveHase extends Component
{
	use WithPagination;
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'HASE Trigo'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'HASE Trigo'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-supportive-hase', [
