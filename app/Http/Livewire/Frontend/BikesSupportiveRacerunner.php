...
class BikesSupportiveRacerunner extends Component
{
	use WithPagination;
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'RaceRunner'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'RaceRunner'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-supportive-racerunner', [
