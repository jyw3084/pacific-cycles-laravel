...
class BikesFoldingBirdy extends Component
{
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'BIRDY'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'BIRDY'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-folding-birdy', [
