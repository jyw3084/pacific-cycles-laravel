...
class BikesFoldingCarryme extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'CARRYME'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'CARRYME'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-folding-carryme', [
