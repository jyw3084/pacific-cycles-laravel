...
class BikesSupportiveMicah extends Component
{
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'MICAH'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'MICAH'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-supportive-micah', [
