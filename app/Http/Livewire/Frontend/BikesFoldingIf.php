...
class BikesFoldingIf extends Component
{
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'IF'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'IF'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-folding-if', [
