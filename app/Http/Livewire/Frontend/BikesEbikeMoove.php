...
class BikesEbikeMoove extends Component
{
	use WithPagination;
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'MOOVE'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'MOOVE'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-ebike-moove', [
