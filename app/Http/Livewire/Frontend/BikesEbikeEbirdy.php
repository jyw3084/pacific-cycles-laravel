...
class BikesEbikeEbirdy extends Component
{
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'E-BIRDY'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'E-BIRDY'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-ebike-ebirdy', [
