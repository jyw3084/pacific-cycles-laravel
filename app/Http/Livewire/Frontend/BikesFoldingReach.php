...
class BikesFoldingReach extends Component
{
    ...
    public function render()
    {
        ...
        $lang = app()->getLocale();
        $bike = Bike::where([['title', 'REACH'], ['locale', $lang]])->first();
        $header = $bike->content;
        $footer = $bike->items;
    	...
    	$getBikeModel = $bikeModel->where([['bike_model', 'REACH'], ['locale', $lang]])->first();
        ...
        return view('livewire.frontend.bikes-folding-reach', [
